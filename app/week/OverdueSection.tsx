          ...
          <div key={task.id} className="border-b border-border-dim pb-4 last:border-b-0 last:pb-0">
            <div className="mb-2 flex items-start gap-3">
              <button
                ...
                className="mt-1 h-5 w-5 flex-shrink-0 rounded-lg border-2 border-border bg-card hover:border-success transition-colors"
            ...
            <div className="ml-8 flex flex-wrap gap-2">
              <button
                ...
                className="rounded-lg border border-border bg-card px-3 py-1 text-xs font-medium text-secondary hover:bg-accent/10 hover:border-accent-dim hover:text-accent-dark transition-colors"
              >
                carry into today
              </button>
              <button
              ...
              <button
                ...
                className="rounded-lg border border-border bg-card px-3 py-1 text-xs font-medium text-tertiary hover:bg-danger-light hover:border-danger hover:text-danger transition-colors"
              >
                let go
              </button>
            </div>

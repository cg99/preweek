...
export function GoalCard({ goal, onToggleMilestone, onAddMilestone, onDeleteMilestone, onEdit, onDelete }: GoalCardProps) {
  ...
  return (
    <div
      className="rounded-2xl border border-border bg-card p-5 cursor-pointer hover:shadow-md transition-shadow"
